...
public class Booking {
    ...
    private static void createBooking(Connection connection, Scanner scanner) {
        try {
            ...
            System.out.println("Status (Pending/Confirmed/Cancelled):");
            ...
            if (!isUserExists(connection, userID)) {
                System.out.println("UserID does not exist. Please enter a valid UserID.");
                return;
            }
    ...
    private static void updateBooking(Connection connection, Scanner scanner) {
        try {
            ...
            System.out.println("Enter new Status (Pending/Confirmed/Cancelled):");
            String newStatus = scanner.next();
            System.out.println("Enter new PaymentStatus:");
            String newPaymentStatus = scanner.next();

            // Check if the new UserID exists in the user table
            if (!isUserExists(connection, newUserID)) {
                System.out.println("New UserID does not exist. Please enter a valid UserID.");
                return;
            }
