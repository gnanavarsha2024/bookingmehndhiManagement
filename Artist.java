...
public class Artist {
    public static void main(String[] args) {
        try {
            ...
            try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/bookingmehndidb1", "root", "vasan@1998");
    ...
    private static void createArtist(Connection connection, Scanner scanner) {
        try {
            ...
            String query = "INSERT INTO artist (ArtistID, Name, Specialty, Phone, Email) VALUES (?, ?, ?, ?, ?)";
            ...
            System.out.println("Error occurred while creating artist");
            e.printStackTrace();
        }
    }
    ...
    private static void readArtists(Connection connection) {
        try {
            ...
            System.out.println("Error occurred while reading artists");
            e.printStackTrace();
        }
    }
    ...
    private static void updateArtist(Connection connection, Scanner scanner) {
        try {
            ...
            String query = "UPDATE artist SET Name=?, Specialty=?, Phone=?, Email=? WHERE ArtistID=?";
            try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
            ...
            System.out.println("Error occurred while updating artist");
            e.printStackTrace();
        }
    }
    ...
    private static void deleteArtist(Connection connection, Scanner scanner) {
        try {
            ...
            System.out.println("Error occurred while deleting artist");
            e.printStackTrace();
        }
    }
}
